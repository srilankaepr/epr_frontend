...
const roles = [
    { name: 'BECOME PROOO',  icon: '💎',  desc: 'Producer Responsibility Organization - Enterprise EPR Management',  color: '#f1c40f',  bg: 'rgba(241, 196, 15, 0.15)',  path: '/register-pro', roleType: 'pro' },
