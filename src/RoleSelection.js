...
const roles = [
    ...
    { name: 'WASTE MANAGEMENT', icon: '🚚', desc: 'Collector/ Transporter/ Recycler/ Total solution', color: '#f39c12', bg: 'rgba(243, 156, 18, 0.15)', path: '/register-customer', roleType: 'RECYCLER' } 
];
