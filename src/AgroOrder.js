...
useEffect(() => {
    ...
    const handleSubmit = async () => {
        ...
        formData.append('division', 'Agro-User');
        ...
        try {
            ...
            if (response.status === 201) {
                ...
                setInvoice(null);
                const updatedOrders = await axios.get(`${API_BASE}/orders/user/${user.email}/Agro-User`);
    ...
    return (
        <div style={styles.container}>
            ...
            <style>
                ...
                .upload-area:hover { border-color: #27ae60 !important; background: rgba(39, 174, 96, 0.1) !important; }
                .tab-button:hover { transform: translateY(-5px); border-color: #27ae60 !important; }
                `}
            </style>
            ...
            <div style={styles.topBar} className="top-bar">
                ...
                <div style={styles.profileArea}>
                    ...
                    <div style={{...styles.profileCircle, border: '2px solid #27ae60'}}>
                        {user.profilePic ? (
                            <img src={user.profilePic} alt="Profile" style={styles.profileImg} />
                        ) : (
                            <span style={{...styles.profileLetter, color: '#27ae60'}}>{user.fullName.charAt(0).toUpperCase()}</span>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div style={styles.tabGrid} className="tab-grid">
                {tabs.map((tab) => (
                    <div 
                        ...
                        style={{
                            ...styles.tabBtn,
                            borderColor: activeTab === tab ? '#27ae60' : 'rgba(255, 255, 255, 0.1)',
                            background: activeTab === tab ? 'rgba(39, 174, 96, 0.2)' : 'rgba(255, 255, 255, 0.05)',
                        }}
                        ...
                        <div style={styles.qrGrid}>
                            <div style={styles.qrCard} className="qr-card">
                                ...
                                <div style={styles.infoRow}>
                                    ...
                                    <span style={{...styles.infoValue, color: '#27ae60'}}>{user.role.toUpperCase()}</span>
                                </div>
                            </div>
                                            ...
                                            <tr key={index} style={styles.tableRow}>
                                                <td style={styles.td}>
                                                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                                                        ...
                                                        <span style={{ fontSize: '11px', opacity: 0.7, color: '#27ae60' }}>{order.time || ''}</span>
                                                    </div>
                                                </td>
