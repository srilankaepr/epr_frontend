...
const ProRegister = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        companyName: '',
        regNumber: '',
        dob: '', // Used as Incorporation Date
        country: 'Sri Lanka',
        address1: '', // Registered Address Line 1
        address2: '', // Registered Address Line 2
        operationalAddress: '',
        orgDistrict: '',
        orgProvince: '',
                        ...
                        <div>
                            ...
                            <div style={styles.row}>
                                <div style={styles.rowItem}>
                                    ...
                                    <select name="country" value={formData.country} style={styles.selectInput} onChange={handleChange} required>
