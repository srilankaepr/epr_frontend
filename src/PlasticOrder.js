    ...
    return (
        <div style={styles.container}>
            ...
            <style>
                ...
                .upload-area:hover { border-color: #00f2fe !important; background: rgba(46, 204, 113, 0.1) !important; }
                .tab-button:hover { transform: translateY(-5px); border-color: #00f2fe !important; }
                `}
            </style>
            ...
            <div style={styles.topBar} className="top-bar">
                <div style={styles.logoArea}>
                    ...
                    <div>
                        ...
                        <div style={{...styles.subTitle, color: '#00f2fe', fontWeight: 'bold'}}>Plastic Division</div>
                    </div>
                </div>
            ...
            <div style={styles.tabGrid} className="tab-grid">
                {tabs.map((tab) => (
                    <div 
                        ...
                        style={{
                            ...styles.tabBtn,
                            borderColor: activeTab === tab ? '#00f2fe' : 'rgba(255, 255, 255, 0.1)',
                    ...
                    >
                        ...
                        <span style={{
                            color: activeTab === tab ? '#00f2fe' : '#fff',
                            fontWeight: 'bold',
                            fontSize: '13px'
                        }}>
                            {tab}
                ...
                {activeTab !== 'VIEW ORDER DETAILS' ? (
                        ...
                        <div style={styles.qrGrid}>
                            <div style={styles.qrCard} className="qr-card">
                                ...
                                <div style={styles.infoRow}>
                                    ...
                                    <span style={{...styles.infoValue, color: '#00f2fe'}}>{user.role.toUpperCase()}</span>
                                </div>
                            </div>

                            <div style={styles.qrCard} className="qr-card">
                                <h3 style={styles.cardTitle}>Upload Plastic Invoice</h3>
                        ...
                        <div style={{textAlign: 'center', marginTop: '30px'}}>
                            <div style={styles.qrPlaceholder}>
                                <div style={styles.qrBox}>
                                    {activeTab === 'ORDER QR' ? "🔳 QR Code" : "♻️ Plastic Order"}
                                </div>
                                <p style={{fontSize: '14px', color: '#00f2fe', marginTop: '10px', fontWeight: 'bold'}}>
                                    {activeTab === 'ORDER QR' ? "Requesting ORDER QR for Plastic Division" : "Place Plastic Order"}
                                </p>
                            </div>
                             {invoice && (
                    ...
                    <div style={{ padding: '20px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                            <h3 style={styles.cardTitle}>Plastic Order History</h3>
                            {orders.length > 0 && (
                        ...
                        <div style={styles.countBadge}>
                            Total Orders: <span style={{color: '#00f2fe'}}>{orders.length}</span>
                        </div>
                                            ...
                                            <tr key={index} style={styles.tableRow}>
                                                <td style={styles.td}>
                                                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                                                        ...
                                                        <span style={{ fontSize: '11px', opacity: 0.7, color: '#00f2fe' }}>{order.time || ''}</span>
                                                    </div>
                                                </td>
        ...
        {order.status === 'QR Sent' && order.qrZipFile && (
            <button 
             ...
             Download QR
                            ...
                            <p style={{ textAlign: 'center', opacity: 0.6, marginTop: '30px' }}>No Plastic order history found.</p>
                        )}
                    </div>
                )}
            </div>
...
const styles = {
    ...
    profileCircle: { width: '45px', height: '45px', background: '#222', borderRadius: '50%', border: '2px solid #00f2fe', display: 'flex', justifyContent: 'center', alignItems: 'center', overflow: 'hidden' },
    profileImg: { width: '100%', height: '100%', objectFit: 'cover' },
    profileLetter: { color: '#00f2fe', fontSize: '20px', fontWeight: 'bold' },
    ...
    qrBox: { fontSize: '32px', color: '#00f2fe', fontWeight: 'bold' },
    ...
    submitBtn: { width: '100%', maxWidth: '400px', padding: '12px', background: '#00f2fe', border: 'none', borderRadius: '10px', color: '#fff', fontWeight: 'bold', cursor: 'pointer' },
    ...
    tableHeader: { borderBottom: '2px solid rgba(108, 201, 222, 0.5)', textAlign: 'left' },
    th: { padding: '12px', color: '#00f2fe', fontSize: '14px' },
